...
export function PrivSwiftPayContent({
 ...
 subtitle="Privacy-first payment infrastructure"
 title="PrivSwiftPay"
 >
 <PrivacyHeroSection />
 ...
 className={`inline-flex h-10 min-w-0 flex-1 items-center justify-center gap-2 rounded-md px-3 text-sm font-semibold transition sm:flex-none ${
 isActive
 ...
 <div className="privacy-hero p-4 sm:p-5">
 <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
 <div>
 <p className="section-eyebrow">Private send</p>
 ...
 <input
 className="h-12 rounded-lg border border-border bg-card px-3 text-sm font-bold text-foreground outline-none transition placeholder:text-muted-foreground focus:border-swift-600 focus:bg-background focus:ring-2 focus:ring-swift-600/15"
 inputMode="decimal"
 ...
 <textarea
 className="min-h-24 resize-y rounded-lg border border-border bg-card px-3 py-3 text-sm font-medium text-foreground outline-none transition placeholder:text-muted-foreground focus:border-swift-600 focus:bg-background focus:ring-2 focus:ring-swift-600/15"
 ...
 <h2 className="mt-3 font-heading text-xl font-semibold tracking-normal text-foreground">
 {walletLabel}
 </h2>
 </div>
 ...
 <div className="flex items-center justify-between gap-3">
 <span className="font-semibold text-muted-foreground">Pool status</span>
 ...
 <div className="rounded-lg border border-border bg-muted px-4 py-4 text-sm font-semibold text-muted-foreground">
 {address
 ...
 <p className="inline-flex max-w-full items-center gap-1.5 truncate text-sm font-bold text-foreground">
 <TokenIcon
 ...
 <button
 className="mt-3 inline-flex h-8 items-center justify-center gap-1 rounded-md border border-border bg-card px-2 text-xs font-bold text-foreground transition hover:border-swift-600 hover:text-swift-700"
 ...
 <h2 className="mt-3 font-heading text-2xl font-semibold tracking-normal text-foreground sm:text-3xl">
 Payment folders
 </h2>
 <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
 ...
 <div className="surface-card px-4 py-4">
 <p className="text-sm font-black text-foreground">Folders</p>
 <div className="mt-3 grid max-h-64 gap-2 overflow-y-auto pr-1">
 {payrollFolders.length === 0 ? (
 <div className="rounded-lg border border-border bg-muted px-3 py-3 text-sm font-semibold text-muted-foreground">
 {address
 ...
 <input
 className="h-12 rounded-lg border border-border bg-card px-3 text-sm font-bold text-foreground outline-none transition placeholder:text-muted-foreground focus:border-swift-600 focus:bg-background focus:ring-2 focus:ring-swift-600/15 disabled:bg-muted disabled:text-muted-foreground"
 ...
 <button
 className="inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-border bg-card px-4 text-sm font-bold text-foreground shadow-sm transition hover:-translate-y-0.5 hover:border-swift-600 active:translate-y-0 disabled:cursor-not-allowed disabled:bg-muted disabled:text-muted-foreground"
 disabled={!activeFolder}
 ...
 <article
 className="grid gap-3 rounded-lg border border-border bg-card px-3 py-3 shadow-sm sm:grid-cols-[1fr_auto]"
 key={recipient.id}
 >
 <div className="min-w-0">
 ...
 <button
 className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-border bg-card text-muted-foreground transition hover:border-rose-200 hover:bg-rose-50 hover:text-rose-700"
 ...
 <button
 className="inline-flex h-8 items-center justify-center gap-1 rounded-md border border-border bg-card px-2 text-xs font-bold text-foreground transition hover:border-swift-600 hover:text-swift-700"
 onClick={() =>
 ...
 <p className="max-h-20 overflow-y-auto break-all rounded-lg bg-muted px-3 py-2 font-mono text-xs font-bold leading-5 text-foreground">
 {record.code}
 </p>
 </article>
 ))}
 ...
 <button
 className="inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-border bg-card px-5 text-sm font-bold text-foreground shadow-sm transition hover:-translate-y-0.5 hover:border-swift-600 active:translate-y-0"
 ...
 <div className="flex items-center justify-between gap-3">
 <span className="font-semibold text-muted-foreground">Connected</span>
 <span className="font-mono text-xs font-bold text-foreground">
 {shortenAddress(address)}
 </span>
 </div>
 ...
 <span className="inline-flex items-center justify-end gap-1.5 text-right font-bold text-foreground">
 {claimPayload ? (
 <>
 <TokenIcon
 className="h-4 w-4 shrink-0 rounded-full"
 ...
 <div className="flex items-center justify-between gap-3">
 <span className="font-semibold text-muted-foreground">Pool</span>
 <span className="text-right font-bold text-foreground">
 {claimPayload?.pool ?? "Not loaded"}
 </span>
 </div>
 <div className="grid gap-1 border-t border-border pt-3">
 <span className="font-semibold text-muted-foreground">Commitment</span>
